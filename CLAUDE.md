...
- New files: `internal/channel/channel.go`, `internal/channel/manager.go`, `internal/channel/config.go`, `internal/channel/bridge.go`, `internal/channel/slack/adapter.go`, `internal/maintenance/scanner.go`, `internal/orchestrator/context_test.go`, plus test files.
