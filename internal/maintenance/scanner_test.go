...
func (m *mockAuditLogger) TracesForWave(_ context.Context, _ string, _ int) ([]audit.TraceRecord, error) {
	return nil, nil
}

func (m *mockAuditLogger) GetTraceStats(_ context.Context) ([]audit.TraceStats, error) {
	return nil, nil
}
